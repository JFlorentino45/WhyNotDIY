 ...
 */
final class Version20231208190107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE likes ADD CONSTRAINT FK_49CA4E7DD6DE06A6 FOREIGN KEY (comment_id_id) REFERENCES comments (id) ON DELETE CASCADE');
    }
